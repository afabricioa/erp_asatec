...
t.defaults={
	buttons:["copy","excel","csv","pdf","print"],name:"main",tabIndex:0,dom:{
		container:{
			...
			tag:"ActiveXObject"in q?"a":"button",className:"btn btn-info",active:"active",disabled:"disabled"
		},buttonLiner:{
			tag:"span",className:""
		}
	}
...
d.extend(r,{
	collection:{
		...
		action:function(a,b,c,e){
			...
			f();
			if(!a){var g=d(c).parents("div.dt-button-collection");
			a=c.position();
			...
			e._collection.find(".dt-button-collection-title").remove();e._collection.prepend('<div class="dt-button-collection-title">'+e.collectionTitle+"</div>");e._collection.addClass(e.collectionLayout).css("display","none").insertAfter(l).stop().fadeIn(e.fade);
