    ...
    f.extend(c.ext.buttons,{
        colvis:function(b,a){
            return{
                extend:"collection",
                text:function(a){
                    return a.i18n("buttons.colvis","Visualização")
                },
        ...
        columnVisibility:{
            ...
            init:function(b,a,d){
                ...
                b.on("column-visibility.dt"+d.namespace,function(a,c){
                    ...
                    1===b.columns(d.columns).count()&&(d.columns=f.inArray(d.columns,e.mapping),
                    a.attr("data-cv-idx",d.columns),
                    a.parent().children("[data-cv-idx]").sort(function(a,b){
                ...
                colvisRestore:{
                    ...
                    init:function(b,a,d){
                        d._visOriginal=b.columns().indexes().map(function(a){return b.column(a).visible()}).toArray()
                    },
